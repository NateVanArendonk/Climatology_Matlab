...
wndspd30 = find(wndspd >= 30); %grab the indices of winds > 10 m/s
breaks = find(diff(wndspd30) ~= 1);  %find where the wind speeds>10 m/s indices
...
actual_ind = wndspd30(storm3.ind);
...
actual_ind = wndspd30(storm6.ind);
...
actual_ind = wndspd30(storm12.ind);
