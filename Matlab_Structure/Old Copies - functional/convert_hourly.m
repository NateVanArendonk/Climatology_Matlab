...
clf
%% Sort by date
load('/Users/andrewmcauliffe/Desktop/Matlab_Struct/station_data/whid_full.mat');
...
%Interp
B.time = datenum(1945,4,1):(1/24):datenum(2017,3,29);
...
%% Save Data
save('Whidbey_hourly.mat','-struct','B');